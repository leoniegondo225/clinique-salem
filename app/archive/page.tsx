  ...
  return (
    <div className="min-h-screen bg-blue-50 flex flex-col items-center py-8 px-4">
      ...
      <div className="max-w-6xl w-full bg-white shadow-lg rounded-xl p-6 mt-8 flex items-center justify-between">
        <div>
          <h2 className="text-1xl font-semibold text-gray-700">Ajouter un document</h2>
          <p className="text-gray-500">Téléchargez un dossier médical ou administratif.</p>
        </div>
        <button
          onClick={handleUpload}
          className="flex items-center gap-3 bg-blue-700 hover:bg-blue-800 text-white font-medium py-2 px-3 rounded-xl shadow-lg transition-all duration-300"
        >
      ...
      <div className="max-w-6xl w-full mt-8">
        <h2 className="text-1xl font-semibold text-gray-800 mb-6">Documents Archivés</h2>
        <div className="overflow-hidden rounded-xl shadow-lg">
          <table className="min-w-full bg-white rounded-xl">
            <thead className="p-4 bg-gradient-to-r from-blue-500 to-green-500">
              <tr>
            ...
            <tbody>
              {documents.map((doc) => (
                <tr key={doc.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3 px-5 text-gray-600">{doc.type}</td>
                  <td className="py-3 px-5 text-gray-600">{doc.size}</td>
                  <td className="py-3 px-5 text-gray-600">{doc.date}</td>
                  <td className="py-3 px-5 text-center flex justify-center gap-4">
                    <button
